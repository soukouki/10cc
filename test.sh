...
assert 20 "int main() { int a; int b; b = 20; return b; }"
...
assert 30 "int main() { if(0) return 10; if(0) return 20; else return 30; }"
...
assert 42 "int f(int* x, int y) { return *x + y; } int main() { int a; a = 40; return f(&a, 2); }"
